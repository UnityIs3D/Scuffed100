...
public class RockManWar : MonoBehaviour
{
    ...
    public Animator rockManEat;
    public GameObject orientation;
    public GameObject rockManHimself;
    ...
    private IEnumerator RollActive()
    {
        while (true)
        {
            ...
            {
                rockManHimself.transform.rotation = Quaternion.Euler(0, 0, 0);
